...
사용:
  python scripts/data_collection/jgi_poll_and_download.py --request-id 587420
  python scripts/data_collection/jgi_poll_and_download.py --request-id 587420 --poll-interval 600  # 10분마다
"""
import argparse
import os
import sys
