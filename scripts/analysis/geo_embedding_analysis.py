...
결과 파일:
  artifacts/benchmarks/benchmark_geo_signal.json
  artifacts/figures/geo_umap.png
"""
import torch
import pickle
import json
...
OUT_JSON = Path("artifacts/benchmarks/benchmark_geo_signal.json")
OUT_PNG = Path("artifacts/figures/geo_umap.png")
