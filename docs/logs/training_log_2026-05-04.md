...
`scripts/benchmarks/benchmark_naylor_drought.py` — linear probe 가뭄 분류 (623 샘플, 80/20):
...
기록: `artifacts/benchmarks/benchmark_naylor.json`

---

## 5. 수확량 v4 재실행 — USDA 감자

`scripts/benchmarks/benchmark_yield_v4.py` (기존 `benchmark_yield.py` 의 v4 버전).
...
기록: `artifacts/benchmarks/benchmark_yield_v4.json`
...
scripts/benchmarks/benchmark_naylor_drought.py # cross-continent OOD
scripts/benchmarks/benchmark_naylor_rf_only.py # RF baseline 후처리
scripts/benchmarks/benchmark_yield_v4.py       # v4 수확량 재실행
...
artifacts/benchmarks/benchmark_naylor.json
artifacts/benchmarks/benchmark_yield_v4.json
docs/logs/training_log_2026-05-04.md           # 이 문서
```
