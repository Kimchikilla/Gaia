...
## v6 / v7 / v8 / v9 통합 비교 (`scripts/evaluation/validate_all_versions.py`)
...
scripts/evaluation/validate_all_versions.py # v6/v7/v8/v9 한 표 비교
checkpoints/gaia_v8/                   # BERT 모델
checkpoints/gaia_v9/                   # BERT + adversarial 모델
artifacts/benchmarks/benchmark_v6_v7_v8_v9.json # 검증 결과
```
