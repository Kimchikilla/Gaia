...
- `scripts/evaluation/validate_diagnostic_heads.py` — random/stratified/5CV + mean baseline + RF 비교
- `scripts/benchmarks/benchmark_diagnostic_classification.py` — 4-class quartile 분류 평가
- `artifacts/benchmarks/benchmark_validation.json` — 회귀 검증 결과
- `artifacts/benchmarks/benchmark_diagnostic_classification.json` — 분류 결과
