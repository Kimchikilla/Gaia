...
> 커뮤니티 반응 — `gaia-corpus` 데이터셋이 Hugging Face Hub 에서 **최근 30일간 약 2,770회 다운로드** 됨 (스냅샷: 2026-05-04). 데이터셋 페이지가 [커뮤니티 표준 진입점](https://huggingface.co/datasets/Kimchikilla/gaia-corpus). 연구 사용 시 데이터셋과 본 레포 모두 인용 부탁드립니다.
